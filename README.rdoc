...
8]Copy https://github.com/amolplay/poly.git which is generated on next page (Bcoz we selected HTTP protocol)

8]git remote add origin https://github.com/amolplay/poly.git
...
git remote add origin https://github.com/amolplay/poly.git
